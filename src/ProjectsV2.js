...
class ProjectsV2 extends Component {
  state = {
    class: "projects",
  ...
  render() {
    return (
      <div className={this.state.class}>
        <h2>Projects V2</h2> <div className="border" />
        <div className="projectDivs">
          <div className="monitors">
            {" "}
            <img
              className="monitor"
              src={require("./images/projects/computer_monitor.png")}
              alt=""
            />
          ...
          <div className="monitors">
            ...
            <div className="recipeDiv">
              ...
              <div className="recipeDesc">
                {" "}
                <div className="descText">
                  <h2>- WTC -</h2> What To Cook with what you have in the
                  fridge? What if you only have 20 minutes? All this and other
